...
DEVELOP_SERVERS=(
  "developers.pagegear.co|19840|ec2-user|/PageGearCloud/www/html/pge/dominios/promptclip|AWS1_SSH_KEY"
)

# Servidores para rama master (producción)
MASTER_SERVERS=(
  "cloud.pagegear.co|19840|ec2-user|/PageGearCloud/www/html/pge/dominios/promptclip|AWS1_SSH_KEY"
)
